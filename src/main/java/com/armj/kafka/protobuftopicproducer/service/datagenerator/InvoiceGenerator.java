...
public class InvoiceGenerator {
    ...
    private Integer getIndex() {
        return invoiceIndex.nextInt(5);
    }

    private Integer getNewInvoiceNumber() {
        return invoiceNumber.nextInt(99999999) + 99999;
    }

    private Integer getNoOfItems() {
        return numberOfItems.nextInt(2) + 1;
    }
    ...
    public PosInvoice getNextInvoice() {
        ...
        Integer itemCount = getNoOfItems();
        ...
        invoice.setCESS(totalAmount * 0.025);
        log.debug(invoice);
        return invoice;
    }
}
